...
namespace UsingMessagingCenter
{
    public class MainPageCS : ContentPage
    {
        public MainPageCS()
        {
            ...
            Button button3 = new Button { Text = "Say Hi to Richard" };
            button3.Clicked += (sender, e) =>
            {
                MessagingCenter.Send<MainPageCS, string>(this, "Hi", "Richard");
            };

            Button button4 = new Button { Text = "Unsubscribe from alert" };
            ...
            Content = new StackLayout
            {
                ...
                Children = { label, button1, button2, button3, button4, listView }
            };
        }
    }
}
