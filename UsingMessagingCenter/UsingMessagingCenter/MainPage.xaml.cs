...
namespace UsingMessagingCenter
{
    public partial class MainPage : ContentPage
    {
        ...
        void OnSayHiToRichardButtonClicked(object sender, EventArgs e)
        {
            MessagingCenter.Send(this, "Hi", "Richard");
        }

        void CountMessages(object sender, EventArgs e)
        {
            MessagingCenter.Send(this, "Count");
        }

        void OnDeleteFirst(object sender, EventArgs e)
        {
            MessagingCenter.Send(this, "DeleteFirst");
        }
        ...
        {
            MessagingCenter.Send(this, "Time");
        }
    }
}
